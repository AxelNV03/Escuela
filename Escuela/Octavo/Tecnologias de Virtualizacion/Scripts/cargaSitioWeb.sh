...
sudo mkdir -p /home/$user/sitios/$site_name

#crea el directorio en la carpeta de sitios de /var
sudo mkdir -p /var/www/$site_name

#Monta el sitio con bind
sudo mount --bind /home/$user/sitios/$site_name /var/www//$site_name
...
#echo "/home/$user/sitios/$site_name /var/www/html/sitios/$site_name none nodev,nosuid,noexec,noatime,bind 0 0" >> /etc/fstab
echo "/home/$user/sitios/$site_name /var/www/$site_name none nodev,nosuid,noexec,noatime,bind 0 0" | sudo tee -a /etc/fstab > /dev/null
...
echo "Borra esto y pega el codigo html del index de tu pagina" | sudo tee -a /home/$user/sitios/$site_name/index.html >/dev/null

#Abre el archivo para editar
sudo nano /home/$user/sitios/$site_name/index.html
