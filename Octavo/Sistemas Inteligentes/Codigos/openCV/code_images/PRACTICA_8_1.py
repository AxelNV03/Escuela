...
#ruta1 = os.path.expanduser("~/Figuras/train/")
ruta1 = "/home/nv/Figuras/train/"
imagenesTrain, etiquetasTrain = cargar_imagenes_y_etiquetas(ruta1, 41,200)
#ruta2 = os.path.expanduser('~/Figuras/test/')
ruta2 = "/home/nv/Figuras/test/"
...
plt.legend()
plt.show()
plt.savefig('../Graficas/grafica.png')  # Guarda la gráfica como un archivo PNG
